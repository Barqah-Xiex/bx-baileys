...
const generateMessageIDV2 = (userId, mode = "brainxiex") => {
    if (mode === "brainxiex") {
...
const generateMessageID = (mode = "brainxiex") => {
    if (mode === "brainxiex") {
        return (0, exports.generateMessageIDV2)(undefined, "brainxiex");
    }
    return '3EB0' + (0, crypto_1.randomBytes)(18).toString('hex').toUpperCase();
};
