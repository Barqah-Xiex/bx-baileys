...
export declare const generateMessageIDV2: (userId?: string, mode?: "brainxiex" | string) => string;
export declare const generateMessageID: (mode?: "brainxiex" | string) => string;
